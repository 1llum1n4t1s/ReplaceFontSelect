...
### Changed
- **等幅フォントを更新**: UDEV Gothic JPDOCを2.2.0へ更新し、最新の字形・修正を反映
...
- **競合フォントの検出を改善**: 入れ子のCSS規則・読み取り可能なimport先・採用済みスタイルシートも走査し、ページ復帰時にも再確認

## [3.0.15] - 2026-08-30

設定ポップアップのお問い合わせダイアログについて、表示・スクロール・ストア配布時の同梱を安定化。
