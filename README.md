...
[![Version](https://img.shields.io/badge/version-1.0.25-blue.svg)](https://github.com/1llum1n4t1s/ReplaceFontSelect)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)

ウェブサイト上の読みづらい日本語フォントを、好みのフォントに自動で置き換える Chrome / Firefox 拡張機能です。
...
This extension automatically replaces hard-to-read fonts on websites with user-selected Japanese fonts. Available for **Chrome** and **Firefox**.
