...
// preset-ibm-plex-sans-jp-moralerspace-neon-jpdoc-w400.js (body=ibm-plex-sans-jp, mono=moralerspace-neon-jpdoc, weight=400)
(() => {
...
@font-face {
  ...
  src:  local("IBM Plex Sans JP"),
        url('__REPLACE_FONT_BASE__src/fonts/IBMPlexSansJP-Regular.woff2') format('woff2');
  font-weight: 100 599;
  font-display: swap;
