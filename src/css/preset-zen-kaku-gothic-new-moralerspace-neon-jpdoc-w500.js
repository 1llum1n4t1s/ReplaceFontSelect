...
// preset-zen-kaku-gothic-new-moralerspace-neon-jpdoc-w500.js (body=zen-kaku-gothic-new, mono=moralerspace-neon-jpdoc, weight=500)
(() => {
...
@font-face {
  ...
  src:  local("Zen Kaku Gothic New"),
        url('__REPLACE_FONT_BASE__src/fonts/ZenKakuGothicNew-Medium.woff2') format('woff2');
  font-weight: 100 599;
  font-display: swap;
