...
// preset-zen-kaku-gothic-new-moralerspace-neon-jpdoc-w400.js (body=zen-kaku-gothic-new, mono=moralerspace-neon-jpdoc, weight=400)
(() => {
...
@font-face {
  ...
  src:  local("Zen Kaku Gothic New"),
        url('__REPLACE_FONT_BASE__src/fonts/ZenKakuGothicNew-Regular.woff2') format('woff2');
  font-weight: 100 599;
  font-display: swap;
...
@font-face {
  ...
  src:  local("Zen Kaku Gothic New Bold"),
        url('__REPLACE_FONT_BASE__src/fonts/ZenKakuGothicNew-Bold.woff2') format('woff2');
  font-weight: 600 900;
  font-display: swap;
  unicode-range: U+3000-30FF, U+3400-4DBF, U+4E00-9FFF, U+F900-FAFF, U+FF00-FFEF;
}
